...
**Portes Track I (jalon I1→I4) :** web `tsc` ✔ + **129/129** tests + build ✔ · API `typecheck` ✔ + **239/239** ✔. Livré : I1 (socle), I2 (transverse), I3 (Catalogue & Stock), I4 (Ventes, Achats & Pilotage + console SA + Paramètres/Abonnement). Restant : I5 (POS vendeur, pont `ApiError.code` → `t("errors.*")`, garde-fou anti-chaînes FR en dur, glossaire métier FR⇄EN).
