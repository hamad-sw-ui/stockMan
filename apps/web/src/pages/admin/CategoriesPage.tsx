      ...
      {form ? (
        ...
        >
          ...
          <Field
            ...
            hint="Plus petit = affiché en premier en caisse."
          >
            <Input
              inputMode="numeric"
          ...
          message={
            <>
              ...
              {(toDelete.product_count ?? 0) > 0 ? (
                <>
                  Elle contient{" "}
                  <strong>{toDelete.product_count} produit(s)</strong> : la
                  suppression sera refusée tant que des produits l’utilisent.
                </>
              ) : (
                "Aucun produit ne l’utilise."
              )}
            </>
          }
