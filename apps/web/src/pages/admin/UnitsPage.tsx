  ...
  return (
    <div className="wrap" style={{ maxWidth: 860 }}>
      ...
      {q.loading ? (
        ...
        >
          Commencez par l’unité de base (Pièce, facteur 1), puis ajoutez les
          unités dérivées.
        </EmptyState>
      ) : (
        <Card pad={false}>
              ...
              <tbody>
                {q.data.map((u) => (
                  <tr key={u.id}>
                    ...
                    <td>
                      {u.is_base ? (
                        <Badge tone="info">Unité de base</Badge>
                      ) : (
                        <Badge>Dérivée</Badge>
                      )}
                    </td>
      ...
      <p className="muted" style={{ fontSize: "0.85rem", marginTop: 10 }}>
        ⚠️ Une unité ayant servi des ventes voit son facteur verrouillé pour
        protéger l’historique.
      </p>

      {form ? (
        <Modal
          title={form.id ? "Modifier l’unité" : "Nouvelle unité"}
        ...
        >
          <div className="row" style={{ flexWrap: "wrap" }}>
            ...
            <Field
              ...
              hint="1 Carton = 12 unités de base → facteur 12."
            >
              <Input
                inputMode="decimal"
      ...
      {toDelete ? (
        <ConfirmModal
          ...
          message={
            <>
              Supprimer « {toDelete.name} » ? Refusé si des produits
              l’utilisent.
            </>
          }
