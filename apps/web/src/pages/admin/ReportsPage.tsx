    ...
    <div className="wrap">
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          action={<Button onClick={() => load()}>Afficher le rapport</Button>}
        >
            ...
            <Kpi
              ...
              sub={
                view.totals.revenue > 0
                  ? `${Math.round((1000 * view.totals.margin) / view.totals.revenue) / 10} % du CA`
                  : undefined
              }
        ...
        <>
          <div className="kpi-grid">
            ...
            />
            <Kpi
              label="Valeur de vente potentielle"
        ...
        <Card
          title="Lots expirés ou proches de la péremption (45 jours)"
          pad={false}
        >
          {view.rows.length === 0 ? (
            <div style={{ padding: 18 }}>
              <EmptyState emoji="🎉" title="Aucun lot à risque">
                Aucune péremption dans les 45 prochains jours.
              </EmptyState>
            </div>
          ) : (
            <div className="table-wrap">
        ...
        >
          {view.rows.length === 0 ? (
            <div style={{ padding: 18 }}>
              <EmptyState emoji="✅" title="Stocks sains">
                Aucune rupture prévue d’ici 14 jours.
              </EmptyState>
            </div>
          ) : (
            <div className="table-wrap">
                    ...
                    <table>
                      ...
                      <tbody>
                        {z.totals.map((t) => (
                          <tr key={t.depot}>
                            <td>{t.depot}</td>
                            <td className="num">{t.sales_count}</td>
