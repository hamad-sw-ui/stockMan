...
export default function SaSupervisionPage() {
  ...
  return (
    <div className="wrap">
      <PageHeader
        title="Supervision"
        sub="Santé de la plateforme et traçabilité des actions éditeur"
      />
      <Tabs
        active={tab}
        onChange={setTab}
      ...
      {active.loading ? (
              ...
              <table>
                ...
                <tbody>
                  {notif.data.byStatus.map((r, i) => (
                    <tr key={i}>
                      <td>
                        {r.channel === "IN_APP" ? "Dans l’app" : r.channel}
                      </td>
                      <td>
                  ...
                  {notif.data.byStatus.length === 0 ? (
                    <tr>
                      <td colSpan={3} className="muted">
                        Aucun envoi sur les 7 derniers jours.
                      </td>
                    </tr>
                  ) : null}
                </tbody>
        ...
        <Card
          title="50 dernières actions éditeur (toutes journalisées)"
          pad={false}
        >
          <div className="table-wrap">
            <table>
